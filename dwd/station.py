...
class Station:
    def __init__(self, node, times):
        ...
        extend_data = node.find('{http://www.opengis.net/kml/2.2}ExtendedData')
        self._forecast = extend_data.findall(
            '{https://opendata.dwd.de/weather/lib/pointforecast_dwd_extension_V1_0.xsd}Forecast'
        )
        self._times = times
    ...
    def forecast(self):
        ...
        for i in self._forecast:
            ...
            values = i.findtext(
                '{https://opendata.dwd.de/weather/lib/pointforecast_dwd_extension_V1_0.xsd}value'
            ).split()
            fc[key] = values
